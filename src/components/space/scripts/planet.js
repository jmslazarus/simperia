elation.extend("space.meshes.planet", function(args, controller) { 
  ...
  this.create = function() {
    //console.log('planet',this.texture)
    var parameters = {
    ...
    var material = new THREE.MeshPhongMaterial(parameters),
        ...
        atmosphere = this.atmosphere = new THREE.Mesh(new THREE.SphereGeometry(this.radius+25000,128,64),new THREE.MeshLambertMaterial({
          shininess: 0,
          specular: 0x000033,
          transparent: true, 
          depthWrite: false,
