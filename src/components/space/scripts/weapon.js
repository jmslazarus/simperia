...
elation.extend('space.equipment.gun', function(name, container, hardpoint) {
  ...
  this.makeSprite = function(size, color, img) {
    ...
    if (!this.spriteTexture)
      this.spriteTexture = THREE.ImageUtils.loadTexture("src/components/space/images/"+img+".png");
    ...
    uniforms = {
      ...
      texture:   { type: "t", value: THREE.ImageUtils.loadTexture( "src/components/space/images/particle.png" ) },
    };
    ...
    var materialargs = {
          ...
          map: THREE.ImageUtils.loadTexture(
            "src/components/space/images/lensflare0.png"
          ),
      blending: THREE.AdditiveBlending,
          depthTest: true,
          depthWrite: false,
