elation.extend("space.meshes.star", function(args, controller) {
  ...
  this.createGeometry = function() {
    ...
    /*
    var parameters = {
      map: THREE.ImageUtils.loadTexture('src/components/space/images/star2.jpg'),
      color: color,
      transparent: true, 
      depthTest: true,
      depthWrite: false,
    ...
    */
    //this.add(sphere);
    var texture = THREE.ImageUtils.loadTexture("src/components/space/images/lensflare0.png");
    ...
    return;
				//var textureFlare0 = THREE.ImageUtils.loadTexture( "src/components/space/images/lensflare0.png" );
				//var textureFlare1 = THREE.ImageUtils.loadTexture( "src/components/space/images/sun_halo.png" );
				var textureFlare2 = THREE.ImageUtils.loadTexture( "src/components/space/images/lensflare2.png" );
				//var textureFlare3 = THREE.ImageUtils.loadTexture( "src/components/space/images/lensflare3.png" );

					var flareColor = new THREE.Color( 0xffffff );
					flareColor.copy( this.light.color );
					THREE.ColorUtils.adjustHSV( flareColor, 0, -0.8, 0.5 );
          
					var lensFlare = new THREE.LensFlare( textureFlare2, .5, 0.6, THREE.AdditiveBlending, flareColor );
					...
					lensFlare.add( textureFlare2, .4, 0.7, THREE.AdditiveBlending );
					lensFlare.add( textureFlare2, .8, 0.9, THREE.AdditiveBlending );
					lensFlare.add( textureFlare2, .3, 1.0, THREE.AdditiveBlending );
