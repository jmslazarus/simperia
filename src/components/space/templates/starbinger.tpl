...
{dependency type="javascript" url="src/three.js/examples/fonts/helvetiker_regular.typeface.js" priority=4}
...
<div id="starbinger" elation:component="space.starbinger" class="main">
